...
export function buildTransmissionPdfUrl(storedUrl: string, zone: string) {
  ...
  if (pdfSegment < 0 || !segments[zoneSegment] || segments[pdfSegment + 6] !== "PRE" || !segments[pdfSegment + 7]?.endsWith(".pdf")) {
